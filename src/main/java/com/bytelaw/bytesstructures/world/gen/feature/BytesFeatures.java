...
public class BytesFeatures {
    ...
    public static final RegistryObject<AncientLootStructure> ANCIENT_LOOT_STRUCTURE = FEATURES.register("ancient_loot", () -> new AncientLootStructure(NoFeatureConfig::deserialize));
